  ...
  return (
    <section>
      ...
      >
        ...
        <Dialog.Contents onClick={() => alert('hey!')}>
          Clickable contents
        </Dialog.Contents>
        ...
        <Dialog.Button as="a" onClick={dialog.close}>
          close a link
        </Dialog.Button>
        <Dialog.Button as="div" onClick={dialog.close}>
          close div
        </Dialog.Button>
      </Dialog>
      ...
      >
        ...
        <Dialog.Button as="a" onClick={dialog2.close}>
          close a link
        </Dialog.Button>
        <Dialog.Button as="div" onClick={dialog2.close}>
          close div
        </Dialog.Button>
      </Dialog>
    </section>
